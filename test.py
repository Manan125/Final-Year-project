...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.readimage.setGeometry(QtCore.QRect(10, 0, 231, 211))
        ...
        self.resultarea.setGeometry(QtCore.QRect(650, 0, 301, 41))
        font = QtGui.QFont()
        ...
        self.deasesarea = QtWidgets.QLabel(self.centralwidget)
        self.deasesarea.setGeometry(QtCore.QRect(650, 70, 391, 301))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.deasesarea.setFont(font)
        self.deasesarea.setAlignment(QtCore.Qt.AlignCenter)
        self.deasesarea.setObjectName("deasesarea")
        ...
        self.greenimage.setGeometry(QtCore.QRect(10, 240, 231, 161))
        ...
        self.blueimage.setGeometry(QtCore.QRect(280, 230, 231, 181))
        ...
        self.yellowimage.setGeometry(QtCore.QRect(270, 20, 231, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.readimage.setText(_translate("MainWindow", "TextLabel"))
        self.resultarea.setText(_translate("MainWindow", "TextLabel"))
        self.deasesarea.setText(_translate("MainWindow", "TextLabel"))
        self.Browesredimage.setText(_translate("MainWindow", "Red Image"))
        self.prediction.setText(_translate("MainWindow", "Prediction"))
        self.greenimage.setText(_translate("MainWindow", "TextLabel"))
        self.blueimage.setText(_translate("MainWindow", "TextLabel"))
        self.yellowimage.setText(_translate("MainWindow", "TextLabel"))
    ...
    def predictions(self):
        ...
        for name in tqdm(submit):
            ...
            predicted.append(str_predict_label)
        print(predicted)
        self.resultarea.setText(label[int(predicted[0])])
